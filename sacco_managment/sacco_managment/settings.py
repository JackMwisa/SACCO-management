...
# Webhook secret for payment provider signature verification
WEBHOOK_SECRET = config('WEBHOOK_SECRET', default='change-this-in-production')
...
MTN_MOMO_API = {
    ...
    'COLLECTION_SECONDARY_KEY': config('MTN_COLLECTION_SECONDARY_KEY', default="123456789"),
    'DISBURSEMENT_PRIMARY_KEY': config('MTN_DISBURSEMENT_PRIMARY_KEY', default="123456789"),
    'DISBURSEMENT_SECONDARY_KEY': config('MTN_DISBURSEMENT_SECONDARY_KEY', default="123456789"),
    'BASE_URL': config('MTN_BASE_URL', default="123456789"),
    'CALLBACK_URL': config('MTN_CALLBACK_URL',  default="123456789"),
